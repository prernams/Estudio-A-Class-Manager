...
public class thurs2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thurs2);
        ...
        reff= FirebaseDatabase.getInstance().getReference().child("Table").child(ID).child("Thursday");
