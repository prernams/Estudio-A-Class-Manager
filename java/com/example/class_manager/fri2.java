...
public class fri2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fri2);
        ...
        reff= FirebaseDatabase.getInstance().getReference().child("Table").child(ID).child("Friday");
