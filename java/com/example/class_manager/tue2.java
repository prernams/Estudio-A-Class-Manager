...
public class tue2 extends AppCompatActivity {
...
String ID;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tue2);
        ...
        reff= FirebaseDatabase.getInstance().getReference().child("Table").child(ID).child("Tuesday");
